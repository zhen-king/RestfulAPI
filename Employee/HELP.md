...
* The following dependencies are not known to work with Spring Native: 'Spring Boot DevTools, Spring Session'. As a
...
* [Configure the Spring AOT Plugin](https://docs.spring.io/spring-native/docs/0.11.2/reference/htmlsingle/#spring-aot-maven)
...
```
$ docker run --rm -p 8080:8080 Employee:0.0.1-SNAPSHOT
```
